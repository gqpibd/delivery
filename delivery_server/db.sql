...
SELECT REQNUMBER, STATE, TITLE, LOCATION, Order_date 
FROM ORDERS WHERE (NVL(ISDEL,0) = 0 AND STATE = '요청중' AND APPLICANTS LIKE '%cc%')
OR DELIVERER='cc' ORDER BY REQNUMBER DESC
